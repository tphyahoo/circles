...
The citation for the algorithm is in `Circle.tla`: the 1977 CACM paper, not the famous
1965 one, which draws lines.
...
Spec == Init /\ [][Next]_tick
    ...
    (*  Bresenham's circle algorithm, transliterated. Walks one octant
