...
<section>
  ...
  <div class="line"><div class="who f">Mrs. Feeney</div><div class="says">
    <p>Now. Here is the middle of that program twice. The eight mirrors are the same in both and I have left them out. Everything else you can see.</p>
    <p>They differ by exactly one number. One of them is right and one of them is wrong. Find the wrong one, by reading.</p>
  </div></div>
